	...
	render() {
		let sideNav = (
					<Nav vertical>
						...
						<hr/>
						<NavItem>
							<Button outline className="btn-block text-left" onClick={() => this.changePage('home')} color="info" size="lg">{this.state.sideNav ? "Home <i className='fa fa-home'></i>" : "<i className='fa fa-home'></i>"}</Button>
						</NavItem>
						<NavItem>
